...
{{ Form::hidden('shipping_method_id', $shipping->shipping_method_id) }}
...
<div class="row">
  ...
  <div class="form-group col-lg-6 col-md-6">
      ...
      {{ Form::select('shipping_method_status', ['1'=>'Yes','0'=>'No'],$shipping->shipping_method_status,['class'=>'form-control']) }}
  </div>
