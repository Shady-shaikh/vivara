...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Create Subcategory</h3>
        ...
        <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
            <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                <div class="btn-group" role="group">
                    <a class="btn btn-outline-primary" href="{{ route('admin.subcategory',['id'=>$id]) }}">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            {{ Form::open(['url' => 'admin/subcategory/store']) }}
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            {{ Form::hidden('category_id', $id , ['class' => 'form-control','required' => true, 'placeholder'=>'Subcategory name']) }}
                                        </div>
                                    </div>
