                              ...
                              <li class="d-inline-block mr-2 mb-1">
                                <fieldset>
                                  <div class="checkbox checkbox-primary">
                                    {{ Form::checkbox('permissions[]', $permission->id, in_array($permission->id,$backend_permission), ['id'=>'permissions['.$permission->id.']']) }}
                                      <!-- <input type="checkbox" id="colorCheckbox1" checked=""> -->
                                      <!-- <label for="colorCheckbox1">{{ $permission->name }}</label> -->
                                      {{ Form::label('permissions['.$permission->id.']', $permission->name) }}
                                  </div>
                                </fieldset>
                              </li>
                              @endforeach
