        ...
        <li class="nav-item dropdown ms-lg-3">
          <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <div class="media d-flex align-items-center">
              ...
              <img class="avatar rounded-circle" src="{{ asset('public/backend-assets/images/dummy.png') }}">
          ...
          <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
            <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.profile',['id' => $user_id]) }}">
  ...
  <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
      <ul class="nav flex-column pt-3 pt-md-0">
          ...
          <a href="{{route('admin.dashboard')}}" class="nav-link d-flex align-items-center mb-3">

              <img src="{{ asset('public/backend-assets/images/logo/logo.png') }}"  width="50%" alt="Volt Logo">
          </a>
        ...
        <li class="nav-item">
          <span
            ...
            <span>
              ...
              <span class="sidebar-text">{{$menu->menu_name}}</span>
            </span>
          ...
          <div class="multi-level collapse "
            ...
            <ul class="flex-column nav">
              @php
                            ...
                            @endphp
              <li class="nav-item ">
                <a class="nav-link text-start" href="{{$suburl}}">
                  <span class="sidebar-text">{{$submenu->submenu_name}}</span>
                </a>
              </li>
              @php
                            }
