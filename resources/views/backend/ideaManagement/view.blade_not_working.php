    ...
    <div class="card-body">
        ...
        <div>
            <div class="row">
                <div class="col-md-12 col-12">
                    ...
                    <div class="full-img-boxin">
                        ...
                        <div class="full-img-box mb-4">
                            ...
                            <a href="{{ asset($full_image_path) }}" target="_blank"><img src="{{asset('/storage/app/public/uploads/asset/png-icon.png')}}" alt="{{ $image_path !== 'null' ? 'Image not available': 'Idea Image' }} "></a>
                ...
                <div class="col-md-12 col-12">
                    <a onclick="confirm('Are you sure you want to approve This Idea for Certificate')" href="{{route('admin.approve_certificate',['id'=>$idea->idea_id])}}" class="btn btn-primary">Approve for Certificate</a>
                </div>
                @else
                <div class="col-md-12 col-12">
