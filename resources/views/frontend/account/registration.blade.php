        ...
        <div class="container-tight py-4">
            <div class="text-center mb-4 mt-2">
                <a href="." class="navbar-brand navbar-brand-autodark"><img
                        src="{{ asset('/public/frontend-assets/images/logo.png') }}" alt=""></a>
            </div>
                    ...
                    <form class="card card-md" action="{{ route('user.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="fields_container">
                                <div>
                                    {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter First Name', 'required']) }}
                                    @error('name')
                                ...
                                {{-- <div>
                                    {{ Form::select('contact_type', ['customer' => 'Customer', 'vendor' => 'Vendor'], null, ['class' => 'form-control', 'placeholder' => 'Select Customer Type', 'required']) }}
                                    @error('contact_type')
                                        <div style="color: red;font-size:0.9em;display:block;text-align:left">
                                            {{ $message }}</div>
                                    @enderror
                                ...
                                <div>
                                    {{ Form::text('mobile_no', null, ['class' => 'form-control', 'placeholder' => 'Enter Mobile No.', 'required']) }}
                                ...
                                {{-- <div> --}}
                                    {{ Form::select('country', [], null, ['class' => 'form-control ','id'=>'country', 'placeholder' => 'Select Country', 'required','style'=>'display:none;']) }}
                                {{-- </div> --}}
                            ...
                            <p class="message">Already have account? <a href="{{ url('/') }}">Sign In</a>
                            </p>
                        </div>
                    </form>
