    ...
    <div class="container-fluid">
        <div class="row g-5">
            ...
            <div class="col-md-5 col-lg-4 order-md-last">
                ...
                <br>
                Shipping Charges : <b><input type="text" class="ship_charge" value="0" readonly
                        style="border:none;outline:none;background:transparent;"></b>
                <br>
                Amount To Pay:
                <b>
                    <input type="text" id="final_amount_s" value="<?= round($final_amount, 2) ?>"
                ...
                <form
                    ...
                    <div class="form-group">
                        ...
                        <select name="shipping_charges" class="form-control w-50" id="shipping_charges" required>
