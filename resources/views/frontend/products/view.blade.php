...
@section('content')
                        ...
                        <div class="product-details">
                            <div class="description">
                                ...
                                <h6 class="d-flex mb-2">
                                    ...
                                    <span class="description" id="item_per_unit_rate"> {{ $item->rate }} </span>
                                </h6>
                                ...
                                <table class="table .table-borderless">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>HSN/SAC</td>
                                            <td id="hsn">{{ !empty($item->hsn_or_sac)?$item->hsn_or_sac: '-' }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
    ...
    <script>
        ...
        function updateCarousel(imageUrl, currentIndex,item_id,currentImage) {
            ...
            if(item_id){
                $.ajax({
                url: '{{ route('products.get_item_images') }}',
                ...
                success: function(response) {
                    ...
                    for(var i=0;i<images.length;i++){
                        // console.log(aClass);
                        url =   "{{ asset('/public/frontend-assets/images/') . '/' }}" + images[i];
