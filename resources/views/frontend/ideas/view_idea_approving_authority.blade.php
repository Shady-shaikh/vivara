                ...
                <div class="col-md-5 col-12">
                        ...
                        <div id="idea_status">
                            ...
                            <div class="idea-status-box mb-2">
                                ...
                                <select class="form-control me-2" id="idea_status" name="idea_status">
                                    <option selected="" disabled="" value="in_assessment">Under Assessment 
                                    </option>
                                    ...
                                    @endphp
                                    <option {{$idea['active_status']==$key?'selected':''}} {{$key=='in_assessment'
                                        ? 'disabled' :'' }} value="{{$key}}">{{$status_option}} {{ $reason }}
                                    </option>
                                    @endforeach
                                </select>
                                <input type="hidden" value="{{$roles_external->role_type}}" name="role">
                                {{-- {{$idea->idea_id}} --}}
                                <input type="hidden" value="{{$idea->idea_id}}" name="idea_id">

                                <button type="submit" class="btn btn-primary"
                                    onclick="return confirm('Are you sure you want to change the Idea Status?')">Submit</button>
                            </div>
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <button type="button" title="click here to change the status of the idea to Implemented"
                            class="btn btn-success" data-toggle="modal" data-target="#app_by_app_auth">Submit for
