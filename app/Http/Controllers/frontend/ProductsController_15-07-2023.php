...
class ProductsController extends Controller
{
    ...
    public function purchase(Request $request, $id)
    {
        ...
        return view('frontend.products.payment.index', compact('user_details', 'item_details', 'increment_id', 'quantity'));
    }
    ...
    {
        // echo $course_id;die;
        $user_details = Users::where(['contact_id' => $id])->first();
        ...
        if (!$existing_payment) // if not
        {
            ...
            foreach ($items as $key => $val) {
                ...
                $line_item = [
                    'item_id' => $val,
                    'rate' => $rate,
                    'quantity' => $items_data->quantity ?? 1,
            ...
            try {
                ...
                if ($newInvoice) {
                    ...
                    // $model->total = $newInvoice->total - $discount;
                    // $model->balance = 0;
    ...
    public function checkout($data)
    {
        ...
        return view('frontend.products.checkout', compact('item', 'customer_data', 'item_data', 'increment_id'));
    }
