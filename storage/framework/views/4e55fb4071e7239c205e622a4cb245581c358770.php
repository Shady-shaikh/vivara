                                        ...
                                        <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if(isset($item->shippingDetails)): ?>
                                                    <a href="<?php echo e(url('admin/invoice/shipping/'.$item->invoice_id.'/'.$item->shippingDetails->shipping_id.'/edit')); ?>" class="btn btn-primary btn-sm">Edit Shipping Status</a>
                                                    <?php else: ?>
                                                    <a href="<?php echo e(url('admin/invoice/shipping/'.$item->invoice_id)); ?>" class="btn btn-primary btn-sm">Create Shipping Status</a>
                                                    <?php endif; ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\vivara\resources\views/backend/invoices/index.blade.php ENDPATH**/ ?>