...
<form action="<?php echo $action; ?>" method="post" name="payuForm" class="d-none">
  ...
  <table>
      ...
      <tr>
          <td>UDF5: </td>
          <td><input name="udf5" value="<?php echo (empty($posted['udf5'])) ? 0 : $posted['udf5']; ?>" /></td>
          <td>PG: </td>
...
<?php echo $__env->make('frontend.layouts.fullempty', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parasigh/public_html/vivara/resources/views/frontend/products/payment/payment.blade.php ENDPATH**/ ?>