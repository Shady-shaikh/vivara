        ...
        <div class="card">
          <div class="card-content">
            <div class="card-body">
              ...
              <form method="POST" action="<?php echo e(route('admin.shipping.store')); ?>" class="form">
                ...
                <div class="form-group col-lg-6 col-md-6">
                    ...
                    <?php echo e(Form::select('shipping_method_status', ['1'=>'Yes','0'=>'No'],null,['class'=>'form-control'])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\vivara\resources\views/backend/shipping/create.blade.php ENDPATH**/ ?>