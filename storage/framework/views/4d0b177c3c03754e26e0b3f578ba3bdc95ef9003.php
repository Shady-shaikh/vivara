                                    ...
                                    <tbody>
                                        ...
                                        <?php if(!empty($taxes)): ?>
                                            <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($i); ?></td>
                                                    <td><?php echo e($item->tax_name); ?></td>
                                                    <td><?php echo e($item->tax_percentage); ?></td>
                                                    <td><?php echo e(!empty($item->tax_specific_type) ? $item->tax_specific_type : 'csgt, sgst'); ?>

                                                    </td>
                                                    <td>
                                                        <?php if(in_array('View Taxes', $permissions)): ?>
                                                            <a href="<?php echo e(url('admin/gst/view/' . $item->tax_id)); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parasigh/public_html/vivara/resources/views/backend/gst/index.blade.php ENDPATH**/ ?>