        ...
        <div class="py-4">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                ...
                <div>
                    ...
                    <?php if(in_array('Create Coupons', $permissions)): ?>
                                        ...
                                        <?php if(isset($coupons) && count($coupons) > 0): ?>
                                            ...
                                            <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($coupon->coupon_title); ?></td>
                                                    <td><?php echo e($coupon->coupon_code); ?></td>
                                                    <td><?php echo e($coupon->end_date); ?></td>
                                                    <td>

                                                        <?php if(in_array('Update Coupons', $permissions)): ?>
                                                            <a href="<?php echo e(url('admin/coupon/edit/' . $coupon->coupon_id)); ?>"
                                                                class="btn btn-primary"><i
                                                                    class="fa-solid fa-pencil"></i></a>
                                                        <?php endif; ?>

                                                        <?php if(in_array('Delete Coupons', $permissions)): ?>
                                                            <?php echo Form::open([
                                                                'method' => 'GET',
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parasigh/public_html/vivara/resources/views/backend/coupon/index.blade.php ENDPATH**/ ?>