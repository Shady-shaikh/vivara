...
Route::get('/products/purchase/{id}', [ProductsController::class, 'purchase'])->name('products.purchase');
Route::get('/products/checkout/{data}', [ProductsController::class, 'checkout'])->name('products.checkout');
...
Route::prefix('admin')->group(function () {
  ...
  Route::group(['middleware' => 'admin.auth'], function () {
    ...
    Route::post('/coupon/getdiscountedamount', [CouponController::class, 'getdiscountedamount'])->name('admin.coupon.getdiscountedamount');
